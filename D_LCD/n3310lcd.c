...
#define LCD_DDR        		DDRB
                                                                                       //mega8  //mega128                             //mega16 
#define LCD_DC_PIN        	    2  //любой пин порта                                   //2      //
#define LCD_CE_PIN              3  //любой пин порта                                   //1      //
#define SPI_MOSI_PIN            5  //должен быть соответствующий пин аппаратного SPI   //3      //2                                   //5
#define LCD_RST_PIN             4  //любой пин порта  //0                              //4      //
#define SPI_CLK_PIN             7  //должен быть соответствующий пин аппаратного SPI   //5      //1                                   //7
                                                                                                // (!) SS -pin must be OUT TOO!                                                 
