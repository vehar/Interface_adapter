...
#warning В релизе - уменьшить
#define SIZE_RECEIVE_BUF  128 /*вместимость приемного буфера*/
#define AMOUNT_PAR 10 /*количество принимаемых слов*/
...
/*argc - количество слов, argv[] - массив указателей на слова*/
